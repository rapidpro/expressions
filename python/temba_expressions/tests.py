...
class FunctionsTest(unittest.TestCase):
    ...
    def test_custom(self):
        ...
        self.assertEqual("Isaac Newton", custom.regex_group(self.context, "Isaac Newton", '(?P<first_name>\w+) (\w+)', 0))
        self.assertEqual("Isaac", custom.regex_group(self.context, "Isaac Newton", '(?P<first_name>\w+) (\w+)', 1))
        self.assertEqual("Newton", custom.regex_group(self.context, "Isaac Newton", '(?P<first_name>\w+) (\w+)', "2"))
        self.assertRaises(ValueError, custom.regex_group, self.context, "Isaac Newton", '(?P<first_name>\w+) (\w+)', 5)
